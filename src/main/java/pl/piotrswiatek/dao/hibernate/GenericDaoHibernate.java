...
import pl.piotrswiatek.dao.hibernate.tools.HibernateSearchTools;
 ...
 *
 * <pre>
 *      &lt;bean id="fooDao" class="pl.cubeitg.util.dao.hibernate.GenericDaoHibernate"&gt;
 *          &lt;constructor-arg value="pl.cubeitg.util.model.Foo"/&gt;
 *      &lt;/bean&gt;
 * </pre>
 *
...
public class GenericDaoHibernate<T, PK extends Serializable> implements
     ...
     */
    @SuppressWarnings("unchecked")
    public List<T> findAll(List<Criterion> criterions) {
        Session sess = getSession();
    ...
    public List<T> findByNamedQuery(String queryName,
        ...
        if (log.isDebugEnabled()) {
            ...
            if (namedQuery != null) {
                log.debug("query string = " + namedQuery.getQueryString());
            }
        }
